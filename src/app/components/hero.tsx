export function Hero() {
  return (
    <section className="relative px-6 pb-8 pt-12 md:py-12 md:pb-8">
      ...
      <h1 className="bg-gradient-to-b from-white to-[#adadad] bg-clip-text text-center text-4xl font-black tracking-tight text-transparent md:text-6xl lg:text-8xl lg:tracking-tighter">Las mejores soluciones cerca de tus manos</h1>
      <p className="leading-1 mx-auto mt-4 text-center text-lg text-[#888] md:px-20 lg:text-2xl lg:leading-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi aliquam totam mollitia asperiores id? Non doloremque illo fugiat dolorem delectus!</p>
